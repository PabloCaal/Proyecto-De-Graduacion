...
% -------------------------------------------------------------------------------
% Título completo
\def \titulotesis {Desarrollo de herramientas de software para el control individual y seguro del microdron Crazyflie 2.1 utilizando odometría visual como método de posicionamiento}
% Año de entrega
\def \anoentrega {2024}
% Asesor
